...
const Settings: React.FC<SettingsPropsInterface> = ({
                                                        max,
                                                        start,
    ...
    return (
        <div className={s.settings__wrapper}>
            <SettingsWindow max={max} start={start} onStartChangeHandler={onStartChangeHandler}
                            onMaxChangeHandler={onMaxChangeHandler} flag2={flag2}/>
